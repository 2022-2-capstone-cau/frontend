...
const Settings = () => {
  ...
  return (
    <>
      ...
      <SettingSection>
        <Link href="/mypage/signout" passHref className="setting-link">
          회원 탈퇴
        </Link>
      </SettingSection>
      <SettingSection>
        <Link href="/mypage/changeNickName" passHref className="setting-link">
          닉네임 변경
        </Link>
      </SettingSection>
      <SettingSection>
        <Link href="/mypage/changePhoto" passHref className="setting-link">
          프로필사진 변경
        </Link>
      </SettingSection>
      <SettingSection>
        <Link href="/mypage/account" passHref className="setting-link">
          계좌 정보
        </Link>
      </SettingSection>
    </>
